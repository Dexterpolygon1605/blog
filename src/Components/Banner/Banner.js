    ...
    return (
        <div className="banner absolute w-50 br4 mt4-m">
            <article class="mw7 center ph3 ph3-ns tc br2 pv5 white mt0">
                <img className="grow w-100 w-40-l w-60-m" src={Profile} alt="Profile" />
                ...
                <div>
                    <a class="shadow-5 f5 f4-ns br-pill no-underline white ba b--white grow pv2 ph4 dib ml3 ml3-ns mr3 mr3-l ml0-m grow"
                        href="0#">
                        View my Projects 
                    </a>
                </div>
