        ...
        return (
                <div inImage={inImage} className="tc">
                    ...
                    <article class="bg-dark-gray tc dib br3 pa0 ma2 bw2 shadow-5 mw5 mw6-ns mw5-m">
                        ...
                        {change === 'picture'
                            ?
                            <a href="https://smartbrainnl.herokuapp.com/" target="blank"> <img src={homepage} class="w-100 db br3 shadow-2 grow dim" alt="Smartbrain" /> </a>
                            :
                    ...
                    <article class="bg-dark-gray tc dib br3 pa0 ma2 bw2 shadow-5 mw5 mw6-ns mw5-m">
                        ...
                        {change === 'picture'
                            ?
                            <a href="https://dexterpolygon1605.github.io/robotfriends/" target="blank"> <img src={rpage} class="w-100 db br3 shadow-2 grow dim" alt="RobotFriends" /> </a>
                            :
                            <p className="desc tl w-70 center" onClick={() => this.onContentChange('picture')} >
                    ...
                    <article class="bg-dark-gray tc dib br3 pa0 ma2 bw2 shadow-5 mw5 mw6-ns mw5-m">
                        ...
                        {change === 'picture'
                            ?
                            <a href="https://portorequintado.netlify.app/" target="blank"> <img src={prpage} class="w-100 db br3 shadow-2 grow dim" alt="PortoRequintado" /> </a>
                            :
                            <p className="desc tl w-70 center" onClick={() => this.onContentChange('picture')} >
